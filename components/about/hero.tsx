    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-black py-28">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <span className="inline-flex rounded-full border border-yellow-500/30 bg-yellow-500/10 px-5 py-2 text-sm font-semibold text-yellow-400">
            About Us
          </span>
          ...
          <p className="mx-auto mt-8 max-w-3xl text-lg leading-8 text-slate-300">
            We provide safe, comfortable and reliable cab services across Pune
            and Maharashtra. Whether it's an airport transfer, a family trip,
            or a business journey, we make every ride smooth and memorable.
          </p>
